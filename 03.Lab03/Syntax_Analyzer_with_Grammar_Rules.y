...
var_declaration : type_specifier declaration_list SEMICOLON
	{
		...
		$$ = new symbol_info($1->getname()+" "+$2->getname()+";", "var_declr");	
	}
	;
...
declaration_list : declaration_list COMMA ID
	{
		...
		$$ = new symbol_info($1->getname()+","+$3->getname(),"declr_list");
	}
	| declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
	{
		...
		$$ = new symbol_info($1->getname()+","+$3->getname()+"["+$5->getname()+"]","declr_list");
	}
	| ID
	{
		...
		$$ = new symbol_info($1->getname(),"declr_list");
	}
